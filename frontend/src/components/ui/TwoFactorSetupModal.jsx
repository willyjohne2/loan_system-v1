        ...
        <div className="p-4 md:p-8">
          {step === 1 && (
            <div className="text-center space-y-4 md:space-y-6">
              <div className="w-16 h-16 md:w-20 md:h-20 bg-primary-100 dark:bg-primary-900/30 rounded-full flex items-center justify-center mx-auto">
                <ShieldCheck className="w-8 h-8 md:w-10 md:h-10 text-primary-600" />
              </div>
              <div>
                <h3 className="text-lg md:text-xl font-bold text-slate-900 dark:text-white">Secure Your Account</h3>
          ...
          {step === 2 && setupData && (
            <div className="space-y-4 md:space-y-6">
              <div className="text-center">
                <h3 className="text-base md:text-lg font-bold text-slate-900 dark:text-white">Setup Authenticator</h3>
                <p className="text-[10px] md:text-xs text-slate-500 mt-1">Scan the QR code below using your app</p>
              </div>

              <div className="flex justify-center p-3 md:p-4 bg-white rounded-xl border-2 border-slate-100">
                <div className="w-[140px] h-[140px] md:w-[180px] md:h-[180px]">
                   <QRCodeSVG value={setupData.otpauth_url} size="100%" />
                </div>
              </div>

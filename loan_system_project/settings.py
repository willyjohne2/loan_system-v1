...
# Security Hardening - Allowed Hosts from env
ALLOWED_HOSTS = os.getenv("ALLOWED_HOSTS", "*").split(",")

# Encryption Key for SecureSettings
...
MIDDLEWARE = [
    ...
    "apps.middleware.IPWhitelistMiddleware",
]
...
# Use faster storage for Render free tier to avoid boot time issues
...
# Disbursement Mode
DISBURSEMENT_MODE = os.getenv("DISBURSEMENT_MODE", "SIMULATION")
